...
(function (root) {
  ...
  const WS = {
    ...
    connect(roomId = DEFAULT_ROOM, token = null, opts = {}) {
      ...
      const SERVER_URL = (typeof window !== 'undefined' && window.__SERVER_URL__) ? window.__SERVER_URL__ : "https://collaborative-canvas-w4ug.onrender.com";
_sock = io(SERVER_URL, ioOpts);
